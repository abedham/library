...
public class AddEmployee extends VBox {
    ...
    private void initAddEmployeeView() {
        ...
        VBox vBox = new VBox(10, hboxEmployeeName, hboxEmployeeAddress,
                hboxSalary, hboxEmail, hboxPassword, chIsAdmin);
        vBox.setAlignment(Pos.CENTER);
        
        Button btn = new Button("Export Data");
        HBox hBox = new HBox(10, vBox, btn);
        ...
        setSpacing(spacing);
        getChildren().addAll(hBox, btnAddEmployee);
    ...
    public void setTvEmployees(TableView tvEmployees) {
        ...
        this.tvEmployees.setMinWidth(900);
